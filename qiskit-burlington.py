...
if __name__ == "__main__":
    print('\n----------------------------------------')
    print('Running IBM Q remote simulator - ibmq_burlington')
    token = 'TOKEN'
    ...
    with open('qiskit_ibmq_burlington_output.txt', 'w') as f:
        f.write(get_n_random_bits(100, circuit, backend))
    print('Done. Generated 100 uniform random bits in qiskit_ibmq_burlington_output.txt')

'''
(qcp) neo@pop-os:~/Desktop/QCP/hw3$ python qiskit-burlington.py 

----------------------------------------
Running IBM Q remote simulator - ibmq_burlington
Credentials already present. Set overwrite=True to overwrite.
100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 20/20 [29:28<00:00, 88.41s/it]
Done. Generated 100 uniform random bits in qiskit_ibmq_burlington_output.txt
